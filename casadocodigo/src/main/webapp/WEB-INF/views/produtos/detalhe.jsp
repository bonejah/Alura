...
<body>
	...
	<nav class="categories-nav">
		<ul class="container">
			...
			<li class="category"><ahref="/collections/livros-desenvolvimento-web"> Web </a></li>
	...
	<article id="${produto.id}">
		...
		<section class="buy-options clearfix">
			<form action='<c:url value="/carrinho/add" />' method="post" class="container">
			    ...
			    <button type="submit" alt="Compre Agora" title="Compre Agora ${produto.titulo}"></button>
			</form>
		</section>
					...
					<form action="" method="POST" id="ss-form" class="form-newsletter">
						<ul>
							<li>
								...
								<input type="hidden" name="backupCache" value="" /><input type="email" name="entry.0.single" value="" class="ss-q-short" id="entry_0"
