...
public class Autor implements java.io.Serializable {
	...
	public Autor(java.lang.Integer id, java.lang.String nome) {
		this.id = id;
		this.nome = nome;
	}
	...
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(Autor.class,
			true);
