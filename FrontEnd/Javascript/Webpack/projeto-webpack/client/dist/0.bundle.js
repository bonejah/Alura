...
let NegociacaoService = class NegociacaoService {
    ...
    obtemNegociacoesDaSemana() {
        ...
        return this._http.get(`${"http://localhost:8080"}/negociacoes/semana`).then(dados => dados.map(objeto => new __WEBPACK_IMPORTED_MODULE_1__Negociacao_js__["a" /* Negociacao */](new Date(objeto.data), objeto.quantidade, objeto.valor)), err => {
    ...
    obtemNegociacoesDaSemanaAnterior() {
        ...
        return this._http.get(`${"http://localhost:8080"}negociacoes/anterior`).then(dados => dados.map(objeto => new __WEBPACK_IMPORTED_MODULE_1__Negociacao_js__["a" /* Negociacao */](new Date(objeto.data), objeto.quantidade, objeto.valor)), err => {
    ...
    obtemNegociacoesDaSemanaRetrasada() {
        ...
        return this._http.get(`${"http://localhost:8080"}/negociacoes/retrasada`).then(dados => dados.map(objeto => new __WEBPACK_IMPORTED_MODULE_1__Negociacao_js__["a" /* Negociacao */](new Date(objeto.data), objeto.quantidade, objeto.valor)), err => {
